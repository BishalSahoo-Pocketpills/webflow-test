...
var define_IMAGES_REMOTE_PATTERNS_default = [{ protocol: "https", hostname: "^(?:^(?:aa1f3dd7\\-2662\\-4287\\-8bbe\\-38618cb32ada\\.wf\\-app\\-prod\\.cosmic\\.webflow\\.services)$)$", port: "", pathname: "^(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$))(?:(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$)).)*?)\\/?)$" }];
